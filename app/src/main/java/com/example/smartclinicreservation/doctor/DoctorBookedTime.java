...
import com.example.smartclinicreservation.adapter.BookedPatientAdapter;
...
import com.example.smartclinicreservation.patient.ITimeSlotLoadListener;
...
public class DoctorBookedTime extends AppCompatActivity implements ITimeSlotLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_booked_time);
        ...
        recycler_time_slot.setLayoutManager(new LinearLayoutManager(DoctorBookedTime.this));
        Calendar start_date = Calendar.getInstance();
        start_date.add(Calendar.DATE, 0);
        Calendar end_date = Calendar.getInstance();
        end_date.add(Calendar.DATE, 7);
        HorizontalCalendar horizontalCalendar = new HorizontalCalendar.Builder(DoctorBookedTime.this, R.id.calenderView).range(start_date, end_date).datesNumberOnScreen(2).mode(HorizontalCalendar.Mode.DAYS)
    ...
    public void onTimeSlotLoadSuccess(List<Patient> timeSlotList, String formattedDate) {
        recycler_time_slot.setAdapter(new BookedPatientAdapter(DoctorBookedTime.this, timeSlotList, formattedDate));
    }
